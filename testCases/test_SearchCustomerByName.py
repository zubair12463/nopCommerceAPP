...
class Test_004_SearchCustomer:
    ...
    def test_SearchCustomer(self,setup):
        self.logger.info("**************** Test_004_SearchCustomer By Name ****************")
        ...
        self.SearchCustomer.setFirstName('Reetam')
        self.SearchCustomer.setLastName('Ghosh')
        self.SearchCustomer.clickSearchButton()
        time.sleep(10)
        self.flag = self.SearchCustomer.verifyCustomerByName()
        if self.flag == True:
         ...
         self.logger.info("**************** Search Customer By Name Test Failed ****************") 
         self.driver.close()
         assert False  
